            ...
            <div className="individual-model-overview-container relative">
                <div className="individual-overview-models bg-white">
                    <div className="individual-overview-image-container relative">
                        ...
                        <img src={item.image} width="2560" height="760" srcSet={item.srcSet} sizes="(min-width: 1920px) 345px,(min-width: 1760px) 20vw,(min-width: 1300px) 25vw,(min-width: 1000px) 30vw,(min-width: 760px) 40vw,(min-width: 480px) 75vw,71vw" alt="911 Carrera" loading="lazy" fetchPriority="auto" style={{ aspectRatio: 2560 / 760 }}></img>
